...
func TestStoreUpdateRefreshesEnvFileBackedRuntimeSettings(t *testing.T) {
	...
	t.Setenv("CHATGPT2API_AUTO_DESTROY_ACCOUNTS_ENABLED", "false")
	t.Setenv("CHATGPT2API_AUTO_DESTROY_ACCOUNT_MINUTES", "60")
	...
	got, err := store.Update(map[string]any{
		...
		"auto_destroy_accounts_enabled":     true,
		"auto_destroy_account_minutes":      15,
	...
	assertConfigValue(t, got, "auto_destroy_accounts_enabled", true)
	assertConfigValue(t, got, "auto_destroy_account_minutes", 15)
	...
	for key, want := range map[string]string{
		...
		"CHATGPT2API_AUTO_DESTROY_ACCOUNTS_ENABLED":     "true",
		"CHATGPT2API_AUTO_DESTROY_ACCOUNT_MINUTES":      "15",
...
func TestStoreUpdateOverridesEnvOnlyRuntimeSettings(t *testing.T) {
	...
	got, err := store.Update(map[string]any{
		...
		"auto_remove_rate_limited_accounts": true,
		"auto_destroy_accounts_enabled":     true,
		"auto_destroy_account_minutes":      20,
		"log_levels":                        []any{"debug", "info"},
	...
	assertConfigValue(t, got, "auto_remove_rate_limited_accounts", true)
	assertConfigValue(t, got, "auto_destroy_accounts_enabled", true)
	assertConfigValue(t, got, "auto_destroy_account_minutes", 20)
	assertConfigValue(t, got, "registration_enabled", false)
	...
	for key, want := range map[string]string{
		...
		"CHATGPT2API_AUTO_REMOVE_RATE_LIMITED_ACCOUNTS": "true",
		"CHATGPT2API_AUTO_DESTROY_ACCOUNTS_ENABLED":     "true",
		"CHATGPT2API_AUTO_DESTROY_ACCOUNT_MINUTES":      "20",
		"CHATGPT2API_LOG_LEVELS":                        "debug,info",
		"CHATGPT2API_REGISTRATION_ENABLED":              "false",
